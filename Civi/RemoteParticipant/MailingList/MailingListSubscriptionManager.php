...
class MailingListSubscriptionManager {
  ...
  public function confirmSubscription(string $token): void {
    ...
    $this->api4->updateEntity(GroupContact::getEntityName(), $groupContact['id'], [
      'status' => 'Added',
  ...
  public function subscribeWithDoubleOptIn(int $contactId, int $groupId, string $subject, string $text): void {
    ...
    $groupContact = $this->api4->execute(GroupContact::getEntityName(), 'get', [
    ...
    if (NULL === $groupContact) {
      ...
      $this->api4->createEntity(GroupContact::getEntityName(), [
        'contact_id' => $contactId,
        'group_id' => $groupId,
        'status' => 'Pending',
      ...
      $this->api4->updateEntity(GroupContact::getEntityName(), $groupContact['id'], $values);
    }

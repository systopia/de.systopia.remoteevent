...
// Make CRM_Remoteevent_ExtensionUtil available.
require_once __DIR__ . '/../../remoteevent.civix.php';
...
addExtensionToClassLoader($loader, 'de.systopia.remoteevent');
 ...
 */
function _remoteevent_test_civicrm_container(ContainerBuilder $container): void {
}

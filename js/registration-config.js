(function ($) {
  $(document).ready(function () {
    ...
    $('[name=is_multiple_registrations]').change(function () {
      $('[name=remote_registration_additional_participants_profile], [name=max_additional_participants], [name=remote_registration_additional_participants_xcm_profile]').closest('.crm-section')
